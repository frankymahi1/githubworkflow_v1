...
@allure.suite("Sybase to Azure Suite")
@allure.feature("Sybase to Azure Workflow")
@pytest.mark.P2
class TestSybaseToAzure:
    ...
    def test_register_physical_dataset_sql(self):
        with allure.step("Running Sybase to Azure - register_physical_dataset"):
    ...
    def test_register_virtual_dataset_sql(self):
        with allure.step("Running Sybase to Azure - register_virtual_dataset"):
    ...
    def test_register_schema_sql(self):
        with allure.step("Running Sybase to Azure - register_schema"):
    ...
    def test_register_task_sql(self):
        with allure.step("Running Sybase to Azure - register_task"):
    ...
    def test_register_task_flows_sql(self):
        with allure.step("Running Sybase to Azure - register_task_flows"):
